                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center gap-4">
                            <Key className="w-28 group-hover:outline-lime-400 outline outline-2 outline-transparent outline-offset-4 transition-all duration-500 group-hover:translate-y-1">
                                shift
                            </Key>
                            <Key className="group-hover:outline-lime-400 outline outline-2 outline-transparent outline-offset-4 transition-all duration-500 group-hover:translate-y-1 delay-150">
                                alt
                            </Key>
                            <Key className="group-hover:outline-lime-400 outline outline-2 outline-transparent outline-offset-4 transition-all duration-500 group-hover:translate-y-1 delay-300">
                                C
                            </Key>
                        </div>
                    </FeatureCard>
